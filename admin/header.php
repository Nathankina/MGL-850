  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px; margin-left: 280px">
        <li class="nav-item">
          <a class="nav-link" href="index.php" style="color: white"> Accueil</a>
        </li>
        <li class="nav-item dropdown" style="color: white">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
            ...
            <li><a class="dropdown-item" href="election.php" style="font-size: 14px">Élections terminées</a></li>
            
          </ul>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="ajouter.php" style="color: white"> Ajouter une  élection</a>
        </li>
      ...
      <ul style="margin-bottom: 0">
          <?php if(!isset($_SESSION['is_VilleLogin'])){ ?>
        ...
        <li class="nav-item">
         ...
         <?php }else{ ?> 
                 <li class="nav-item">
          <a class="nav-link" href="#" style="color: white; font-weight: 700"><?php echo $UserData['name']; ?></a>
        </li>
