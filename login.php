      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form method="POST" action="backend.php">
          ...
          <div class="form-outline mb-4">
            <label class="form-label" for="form3Example3">Numero d'assurance sociale</label>
            <input type="text" id="form3Example3" class="form-control" name="nas" 
              placeholder="Entrez votre numero d'assurance sociale" required="" />
